    ...
    return(
        <section className="bg-white py-6 px-6 md:px-12">
            <div className="max-w-4xl mx-auto text-center mb-14">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6"> Why Attend this Event</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                {features.map((item, i) => (
                    ...
                    key={i} className=" bg-[#f9fafb] p-6 rounded-2xl shadow-sm hover:shadow-md transition text-center">
                        <h4 className="text-xl font-semibold text-[#009639] mb-3">{item.title}</h4>
