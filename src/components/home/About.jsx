...
export default function About() {
  return (
    <section className="py-30 px-4 sm:px-8 md:px-12 lg:px-20">
      <div className="max-w-7xl pl-18 flex flex-col md:flex-row gap-10 items-center">
        ...
        >
          ...
          <div className="flex gap-4">
            <Users className="w-10 h-10 text-[#007847]" />
            <div>
          ...
          <div className="flex gap-4">
            <Wrench className="w-10 h-10 text-[#007847]" />
            <div>
          ...
          <div className="flex gap-4">
            <HeartHandshake className="w-10 h-10 text-[#007847]" />
            <div>
