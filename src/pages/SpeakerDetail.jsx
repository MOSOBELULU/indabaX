...
return(
    <div className="max-w-6xl mx-auto px-4 pt-28 pb-12">
        <div className="mb-6">
            ...
            className="inline-flex items-center text-[#009639] hover:underline">
        ...
        <h4 className="text-xl text-gray-700 mb-4">{speaker.profession}</h4>
        <p className="text-gray-600 leading-relaxed">{speaker.background}</p>
            </div>
        </div>
    </div>
)
